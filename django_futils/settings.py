...
# Required variables.
from SECRET_SETTINGS import SECRET_KEY, DB_NAME, DB_USER, DB_PASSWORD, DB_HOST, DB_PORT, MEDIA_ROOT, MEDIA_URL, INTERNAL_IPS, DEBUG, ALLOWED_HOSTS, LANGUAGE_CODE, TIME_ZONE, USE_X_FORWARDED_HOST, STATIC_URL, STATIC_ROOT_SUFFIX, STATICFILES_DIR_SUFFIX, LOCALE_DIR_SUFFIX, HASHID_FIELD_SALT
